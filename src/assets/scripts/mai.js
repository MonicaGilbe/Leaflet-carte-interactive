...
let iconCamping = L.icon({

    iconUrl: "/src/assets/images/camping.png",
    iconSize: [40, 40],
});

let iconPlage = L.icon({

    iconUrl: "/src/assets/images/plage.png",
    iconSize: [40, 40],
});
...
// Couche d'informations en ligne
...
let  campingBaieVerte = L.marker([48.74166294397123, -69.05483023391093], {icon:iconCamping});
let  campingPortneufSurMer = L.marker([48.646329315529435, -69.0932702926452],  {icon:iconCamping});
let  campingParadisMarin = L.marker([48.28430400110731, -69.46334898104324],  {icon:iconCamping});
let  campingLeTipi = L.marker([48.347521316650415, -69.39834479456435],  {icon:iconCamping});


// let plages = L.layerGroup();

let plageBaieVerte = L.marker([48.740556632273844, -69.05760545702775],  {icon:iconPlage});
let plageEssipit = L.marker([48.93947818036687, -68.63595568077419],  {icon:iconPlage});
let plagePointeFortin = L.marker([48.641159694894206, -69.08627116504347],  {icon:iconPlage});
let plageLonguerive = L.marker([48.54199082543449, -69.24985202978472],  {icon:iconPlage});
let plagePointeBoisvert = L.marker([48.572409544933656, -69.19270703293581],  {icon:iconPlage});
let plageBergeronnes = L.marker([48.23115862563465, -69.54126601859635],  {icon:iconPlage});
let plageTadoussac = L.marker([48.159482806917, -69.72629549963156],  {icon:iconPlage});
...
let informations = {
        ...
        "<strong>Camping</strong> la Baie-Verte": campingBaieVerte,
        "<strong>Camping</strong> Portneuf-Sur-Mer": campingPortneufSurMer,
        "<strong>Camping</strong> Paradis Marin": campingParadisMarin,
        "<strong>Camping</strong> le Tipi": campingLeTipi,
        "<strong>Plage</strong> Baie-Verte": plageBaieVerte,
        "<strong>Plage</strong> Essipit": plageEssipit,
        "<strong>Plage</strong> Pointe-Fortin": plagePointeFortin,
        "<strong>Plage</strong> Longue-rive": plageLonguerive,
        "<strong>Plage</strong> Point-à-boisvert": plagePointeBoisvert,
        "<strong>Plage</strong> Bergeronnes": plageBergeronnes,
        "<strong>Plage</strong> Tadoussac": plageTadoussac,
};
...
legend.onAdd = function (map) {
    ...
    grades = [0, 100, 200, 400, 600, 800, 1000, 1500, 2000];
